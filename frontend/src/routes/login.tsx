...
export const Route = createFileRoute("/login")({
  ...
  head: () => ({
    meta: [
      { title: "Sign in — CoreHex Rental" },
      { name: "description", content: "Sign in to manage bookings and rentals." },
    ],
  }),
  component: LoginPage,
});
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {redirect ? "Sign in to continue with your booking." : "Manage your rentals and bookings."}
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => toast.message("Contact support to reset your password")}
